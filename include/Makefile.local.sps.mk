...
SPS_LIBS_DEP_MPI = $(RPNPHY_LIBS_V) $(MODELUTILS_LIBS_NOSTUBS_V) $(SPS_LIBS_V) $(RPNPHY_LIBS_V) $(MODELUTILS_LIBS_NOSTUBS_V) $(MODELUTILS_LIBS_DEP_MPI)
SPS_LIBS_DEP_NOMPI = $(RPNPHY_LIBS_V) $(MODELUTILS_LIBS_NOSTUBS_V) $(SPS_LIBS_V) $(RPNPHY_LIBS_V) $(MODELUTILS_LIBS_NOSTUBS_V) $(MODELUTILS_LIBS_DEP_NOMPI)
...
$(BINDIR)/$(mainsps): $(SPS_ABS_DEP) | $(SPS_VFILES)
	...
	export RBUILD_LIBAPPL="$(SPS_LIBS_V) $(SPS_LIBS_DEP_MPI)" ;\
	$(RBUILD4objMPI)
...
$(BINDIR)/$(mainsps_yyencode): $(SPS_ABS_DEP) | $(MODELUTILS_VFILES)
	...
	export ATM_MODEL_NAME="$${MAINSUBNAME} $(BUILDNAME)" ;\
	export ATM_MODEL_VERSION="$(SPS_VERSION)" ;\
	export RBUILD_LIBAPPL="$(SPS_LIBS_V) $(SPS_LIBS_DEP_NOMPI)" ;\
